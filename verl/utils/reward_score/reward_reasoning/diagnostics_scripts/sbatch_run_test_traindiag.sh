...
#SBATCH -n 2
#SBATCH -t 08:00:00
#SBATCH -o output_test_traindiag.log

# Train-vs-test greedy diagnostic: retriever (amazon corpus) on node 0,
# greedy decode + eval.py on node 1 via test_in_container_traindiag.sh.
