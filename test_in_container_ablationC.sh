...
# This script evaluates a trained checkpoint for Ablation C (no reasoning) inside the Singularity container.
# Usage: bash test_in_container_ablationC.sh
...
export TRAIN_DATA_DIR=${TRAIN_DATA_DIR:-'./data/amazon_data/ablations/ablation_c_no_reasoning'}
export TEST_DATA_DIR=${TEST_DATA_DIR:-'./data/amazon_data/ablations/ablation_c_no_reasoning'}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-nq-search-r1-grpo-qwen3-1.7b-sbatch-ablationC}
