...
# Usage: bash run_in_container_ablationB.sh [--checkpoint /path/to/global_step_XXX]
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    --checkpoint|--checkpoint-path)
      ...
      ;;
    -h|--help)
      echo "Usage: bash run_in_container_ablationB.sh [--checkpoint /path/to/global_step_XXX]"
      exit 0
      ;;
    *)
...
export TRAIN_DATA_DIR='./data/amazon_data/ablations/ablation_b_interaction_only'
export TEST_DATA_DIR='./data/amazon_data/ablations/ablation_b_interaction_only'
...
export EXPERIMENT_NAME=nq-search-r1-grpo-qwen3-1.7b-sbatch-ablationB
