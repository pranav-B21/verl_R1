...
export TRAIN_DATA_DIR=${TRAIN_DATA_DIR:-'./data/amazon_data/ablations/ablation_a_metadata_only'}
export TEST_DATA_DIR=${TEST_DATA_DIR:-'./data/amazon_data/ablations/ablation_a_metadata_only'}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-nq-search-r1-grpo-qwen3-1.7b-sbatch-ablationA}
